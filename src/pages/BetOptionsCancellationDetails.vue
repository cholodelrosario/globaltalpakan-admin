    ...
    methods:{
        ...
        saveRefunds(){
            ...
            winnings.forEach(a=>{
                ...
                this.AddGameNotifs(true,'REFUNDED',id,credit,null,null,this.CancelledGames)
        ...
        async updateWinInTeamGameAccount(key,status,odds){
            try {
                const response = await firebaseDb.collection('TeamGameAccountOptionsBets').doc(key).get()
